...
class AlertService:
    def __init__(self, repository: AlertRepository):
        ...
        self.threshold = float(os.getenv('ALERT_THRESHOLD', '100'))  # default to 100 if not set

    def check_and_create_alert(self, interaction_id: int, element: str, metric_value: float, metrics: list):
